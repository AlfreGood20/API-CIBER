        ...
        switch (create.tipoProducto()) {
            case JUEGO:
                Juego juego=juegoRepo.findById(productoId)
                    .orElseThrow(()-> new RecursoNoEncontradoException("El juego id "+productoId+" no encontrado"));
            ...
            case UTILIDAD:
                Utilidad utilidad=utilidadRepo.findById(productoId)
                    .orElseThrow(()-> new RecursoNoEncontradoException("La utilidad id "+productoId+" no encontrado"));
